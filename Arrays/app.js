...
color.map((element, index )=> {
  if(index===0){
    console.log(`${index+1}${o[index+1]} choice is ${color[index]}`)
  }else if(index===1){
     console.log(`${index+1}${o[index+1]} choice is ${color[index]}`)    
   }
  else if(index===2){
     ...
     console.log(`${index+1}${o[0]} choice is ${color[index]}`)
   }
})
...
let webDevelopers = employees.filter(employee => employee.Job === 'Web Developer')
console.log(webDevelopers)

//Nigeria web developer
let nigeriaWebDevelopers = employees.filter(employee => employee.Job === 'Web Developer' && employee.Country === 'Nigeria')
console.log(nigeriaWebDevelopers)

//employee less than 20 years of age
let result = employees.filter(employee => employee.age < 20)
console.log(result)
